return {
...

  {
    ...
    keys = {
      { "<leader>ff",  "<cmd>Telescope find_files<cr>",                                                                        desc = "Telescope: Fuzzy finder" },
      ...
      { "<leader>fl",  "<cmd>Telescope resume<cr>",                                                                            desc = "Telescope: Open last search" },
      ...
      { "<C-p>",       "<cmd>Telescope git_files<cr>",                                                                         desc = "Telescope: Git project files" },
    },
    lazy = false,
  },
